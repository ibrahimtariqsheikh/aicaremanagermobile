...
class Agency extends Equatable {
  ...
  Agency copyWith({
    ...
    return Agency(
      ...
      isWeek1And2ScheduleEnabled:
          isWeek1And2ScheduleEnabled ?? this.isWeek1And2ScheduleEnabled,
      hasPoliciesAndProcedures:
          hasPoliciesAndProcedures ?? this.hasPoliciesAndProcedures,
      isTestAccount: isTestAccount ?? this.isTestAccount,
      allowCareWorkersEditCheckIn:
          allowCareWorkersEditCheckIn ?? this.allowCareWorkersEditCheckIn,
      ...
      enableWeek1And2Scheduling:
          enableWeek1And2Scheduling ?? this.enableWeek1And2Scheduling,
      ...
      clientBirthdayReminders:
          clientBirthdayReminders ?? this.clientBirthdayReminders,
      careWorkerVisitAlerts:
          careWorkerVisitAlerts ?? this.careWorkerVisitAlerts,
      missedMedicationAlerts:
          missedMedicationAlerts ?? this.missedMedicationAlerts,
      clientAndCareWorkerReminders:
          clientAndCareWorkerReminders ?? this.clientAndCareWorkerReminders,
  ...
  factory Agency.fromJson(Map<String, dynamic> json) {
    return Agency(
      ...
      clientAndCareWorkerReminders:
          json['clientAndCareWorkerReminders'] as bool,
      distanceAlerts: json['distanceAlerts'] as bool,
      reviewNotifications: json['reviewNotifications'] as bool,
      preferredNotificationMethod:
          PreferredNotificationMethod.values.firstWhere(
        (e) =>
            e.toString().split('.').last == json['preferredNotificationMethod'],
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'preferredNotificationMethod':
          preferredNotificationMethod.toString().split('.').last,
